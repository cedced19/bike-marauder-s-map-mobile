...
export default {
  ...
  // Segment
  segmentBackgroundColor: "#12906f",
  segmentActiveBackgroundColor: "#fff",
  segmentTextColor: "#fff",
  segmentActiveTextColor: "#12906f",
  segmentBorderColor: "#fff",
  segmentBorderColorMain: "#12906f",
